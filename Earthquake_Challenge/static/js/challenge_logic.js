...
console.log("working");
  ...
  // create the tile layer that will be the default background for the map.
...
// Accessing the usgs earthquakes feed for last 7 days
...
let tecPlates = "https://raw.githubusercontent.com/fraxen/tectonicplates/master/GeoJSON/PB2002_boundaries.json";
 // d3.json().then(() {
  ...
  // Use d3.json to make a call to get major earthquakes (mag > 4.5)
  bigQuakes = "https://earthquake.usgs.gov/earthquakes/feed/v1.0/summary/4.5_week.geojson";
